...
class TestFunctionRegistry:
    ...
    def test_all_functions_registered(self):
        ...
        expected_functions = [
            ...
            "send_lesson", "send_todays_lesson", 
            "set_timezone", "set_language", "set_preferred_time", "update_profile",
            "confirm_yes", "confirm_no", "extract_memory"
        ]
...
```"""
    ...
    def test_parse_invalid_function_name(self):
        ...
        response = json.dumps({
            "response": "Testing",
            "functions": [{"name": "unknown_function", "parameters": {}}]
        })
...
class TestResponseBuilder:
        ...
        execution_result = BatchExecutionResult(
            results=[
                ExecutionResult(
                    ...
                    success=True,
                    result={"time": "09:00", "schedule_id": 1}
                ),
                ExecutionResult(
    ...
    def test_build_simple_response(self):
        ...
        text = builder.build_simple_response(
            ai_response_text="Hello there!",
...
class TestIntegration:
    ...
    def test_full_parse_and_validate_flow(self):
        ...
        for func in parse_result.functions:
            is_valid, errors = registry.validate_call(
                func["name"],
                func["parameters"]
            )
