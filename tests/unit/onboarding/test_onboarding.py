...
class TestOnboarding:
    ...
    async def test_complete_onboarding_flow(self, db_session):
        """Given: A new user
        When: Going through complete onboarding flow (name + consent only)
        ...
        # Then: Onboarding should be complete and schedule should be auto-created
    ...
    async def test_consent_granted_completes_onboarding(self, db_session):
        ...
        Then: Should complete onboarding immediately
        """
        # Given: A new user
        ...
        # Then: Response should include thank-you and onboarding complete message
        assert "Thank you" in response or "Takk" in response
        assert "Welcome" in response or "Velkommen" in response or "spiritual community" in response
