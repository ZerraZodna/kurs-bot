...
async def test_process_message_creates_one_time_reminder_with_tomorrow(monkeypatch):
    ...
    try:
        ...
        # Ensure a daily schedule exists for this user
        ...
        # Call process_message which will invoke the fake trigger handler
        ...
        # Verify schedules: one daily should remain and one one-time created
        ...
        # Check stored schedule message memory
        mm = MemoryManager(db)
