...
class ParameterValidator:
    ...
    def validate_timezone(tz_str: str) -> Tuple[bool, Optional[str], Optional[str]]:
        ...
        return False, None, f"Unknown timezone: {tz_str}. Please use IANA format (e.g., Europe/Oslo) or common city names."
    ...
    def validate_language(lang_str: str) -> Tuple[bool, Optional[str], Optional[str]]:
        ...
        valid_codes = {
            "en", "no", "es", "de", "fr", "it", "pt", "nl", "sv", "da", "fi",
            "us", "gb", "au", "ca", "nz",  # Common variants
        }
...
def get_common_timezones() -> set:
    ...
    return {
        "Europe/Oslo", "Europe/Stockholm", "Europe/Copenhagen", "Europe/Helsinki",
        ...
        "Asia/Seoul", "Asia/Bangkok", "Asia/Mumbai", "Asia/Dubai",
        "Asia/Jerusalem", "Asia/Tehran", "Asia/Karachi", "Asia/Jakarta",
